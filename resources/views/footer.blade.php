    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Any questions? Let us know in store at xuan do, cu khoi, long bien, ha noi or call us on (+84) 0376679803
                </p>
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Công Kiên</a> &amp; distributed by <a href="#" target="_blank">ThemeKienCong</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
